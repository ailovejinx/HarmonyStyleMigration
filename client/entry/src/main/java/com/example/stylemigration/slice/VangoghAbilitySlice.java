...
public class VangoghAbilitySlice extends AbilitySlice {
    ...
    private String urlStrUpload = "http://101.200.209.222:5050/upload/vangogh";
    private String urlStrDld = "http://101.200.209.222:5050/VangoghWeights/test_fake.png";
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_ability_vangogh);
        // 隐藏状态栏、设置状态栏和导航栏透明
